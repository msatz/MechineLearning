...
class ML2ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    
    let mlModel = RiceSoupClassifiter()
